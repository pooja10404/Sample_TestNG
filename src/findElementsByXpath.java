...
public class findElementsByXpath {
    ...
    public void findElements_ByTagName() {
        try {
            ...
            Thread.sleep(2000);
            List<WebElement> allInputElements = driver.findElements(By.xpath("//button[@id = 'submit']"));
            if(allInputElements.size() != 0)
            {
                System.out.println(allInputElements.size() + " Elements found by xpath as input \n");
