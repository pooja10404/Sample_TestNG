...
public class getTextFunctionality {
    WebDriver driver;
    ...
    @Test(priority = 1)
    public void getText_Functionality() {
        try {
            waitForPageLoad();
            Thread.sleep(2000);
            ...
            String expectedText = expectedTitle.getText();
            // verify excepted and actual text
            Assert.assertEquals(expectedText, "Add Employee");
